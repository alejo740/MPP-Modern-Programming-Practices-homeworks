...
public class Problem1 {
	...
	public static List<String> elementsInJustOne(List<String> list1, List<String> list2) {
		//implement
		return Stream.concat(list1.stream(), list2.stream()).filter(x -> {
			return (list1.contains(x) && !list2.contains(x)) || (!list1.contains(x) && list2.contains(x));
